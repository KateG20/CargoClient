...
class _CurrentRequestPageState extends State<CurrentRequestPage> {
  var requests = [
    Request(
        DateTime.utc(2021, 4, 20), Duration(hours: 5), 120, "ТЛЦ", "Москва"),
    Request(DateTime.utc(2021, 5, 3), Duration(minutes: 32), 60,
        "Александровск-Сахалинский", "ТЛЦ")
  ];
